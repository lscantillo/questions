module RestApiController
  ...
  included do
    ...
    def index
      ...
      @serializer = "#{resource_class}Serializer".constantize if @serializer.nil?
      if params[:items].nil?
        ...
        render json: { data: serialize(@resources, @serializer)[resource_class.to_s.pluralize.downcase.to_sym], pagy: pagy_metadata(@pagy) }, status: :ok
      end
    end
